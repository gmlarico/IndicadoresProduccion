...
var Codebase = function() {
    ...
    var uiHelperSelect2 = function () {
        ...
        jQuery('.js-select2:not(.js-select2-enabled)').each(function(){
            ...
            if (typeof Resinplast.Indicadores.Web.Global.Format.Language !== 'undefined') {
                localLanguage = Resinplast.Indicadores.Web.Global.Format.Language.toLowerCase();
            }
    ...
    return {
        init: function() {
            ...
            uiHandleNav();
            uiHandleForms();
            fnFormsReset(); //FunctionMaster made in VM
            uiHandleTheme();
